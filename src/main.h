...
#define FLASH_FW_BEGIN			(FLASH_BL_PAGES * FLASH_PAGE_SIZE)
#define FLASH_FW_END			(FLASH_TOTAL_PAGES * FLASH_PAGE_SIZE)
#define FLASH_PAGES(bytes)		( (bytes+FLASH_PAGE_SIZE-1)/FLASH_PAGE_SIZE )
